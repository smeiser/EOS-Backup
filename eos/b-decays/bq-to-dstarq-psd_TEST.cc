...
class BqToDstarqPSDTest :
    public TestCase
{
    public:
        BqToDstarqPSDTest() :
            TestCase("bq_to_dstarq_psd_test")
        {
        }
        ...
        virtual void run() const
        {
            // Standard Model NLO
            {
                ...
                BqToDstarqPseudoscalar d(p, oo);
                {
                    ...
                    TEST_CHECK_RELATIVE_ERROR(d.re_a_1(), -1.0404246575973617  , eps);
                    TEST_CHECK_RELATIVE_ERROR(d.im_a_1(), -0.013816465391413044, eps);

                    TEST_CHECK_RELATIVE_ERROR(d.decay_width(),     1.223868880474119e-16 , eps);
                    TEST_CHECK_RELATIVE_ERROR(d.branching_ratio(), 0.00028244558332424593, eps);
                }
            }
            ...
            // Standard Model NLP
            {
                ...
                BqToDstarqPseudoscalar d(p, oo);
                {
                    ...
                    TEST_CHECK_NEARLY_EQUAL(d.im_a_1(), 0, eps);
                }
            }
            ...
            // BSM NLO test case
            {
...

                {
                    ...
                    TEST_CHECK_RELATIVE_ERROR(d.branching_ratio(), 0.39134980265175184,    eps);
                }
            }
            ...
            // BSM NLP test case
            {
...

                {
                    ...
                    TEST_CHECK_RELATIVE_ERROR(d.re_a_1(), 0.148651,  eps);
                    TEST_CHECK_RELATIVE_ERROR(d.im_a_1(), 0.142425, eps);
                }
            }
        }
} bq_to_dstarq_psd_test;
